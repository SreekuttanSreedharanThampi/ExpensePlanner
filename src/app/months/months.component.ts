...
export class MonthsComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    //This will execute whenever a navigation is clicked from side nav
    ...
    if(response){
      this.months.forEach((month, index) => {
        if(
          ...
          this.datasource.deleteRequiredMonth(monthYear, monthNumber).subscribe((res) => {
